...
const Books = ({ booksData, setBooksData }) => {
  ...
  const BookForm = () => {
    const currentBook = formType === "edit" && editIndex !== null ? booksData[editIndex] : null;
          ...
          >
            <Stack height={"100%"} p={3} alignItems="space-center" justifyContent="space-around">
              <TextField
                ...
                label="Book ID"
                id="bookId"
                value={currentBook ? currentBook.bookId : booksData.length ? +booksData[booksData.length - 1].bookId + 1 : 1}
              />
              <TextField
                required
                variant="outlined"
              ...
              <Stack direction="row" alignItems="center" gap="20px">
                ...
                <RadioGroup
                  row
                  defaultValue={currentBook ? (currentBook.issued ? "issued" : "available") : "available"}
                  name="issued"
                >
