...
const Members = ({ membersData, setMembersData }) => {
  ...
  if(!membersData) return <h1>loading</h1>

  const MemberForm = () => {
    const currentMember = formType === "edit" && editIndex !== null ? membersData[editIndex] : null;
          ...
          >
            <Stack height={"100%"} p={3} alignItems="space-center" justifyContent="space-around">
              <TextField
                ...
                label="Membership No."
                id="memId"
                value={currentMember ? currentMember.memId : membersData.length ? +membersData[membersData.length - 1].memId + 1 : 1}
              />
              <TextField
                required
                variant="outlined"
                id="name"
                label="Name"
                defaultValue={currentMember ? currentMember.name : ""}
              />
              <TextField
                required
                variant="outlined"
                ...
                defaultValue={currentMember ? currentMember.phone : ""}
              />
              <TextField
                required
                variant="outlined"
                ...
                defaultValue={currentMember ? currentMember.email : ""}
              />
              <TextField
                required
                variant="outlined"
                ...
                type="number"
                inputProps={{ min: "0" }}
                defaultValue={currentMember ? currentMember.fine : 0}
                InputProps={{
